...
from signer import sign_message, verify_signature

# Separador para melhor visualização
print("\n" + "="*40)
print("TESTE: Assinatura Digital RSA com Formatação")
print("="*40)
...
# Criando assinatura
print("\nGerando assinatura...")
signature_json = sign_message(private_key, message)
print("Assinatura gerada (JSON):", signature_json)

# Verificando assinatura
print("\nVerificando assinatura...")
is_valid = verify_signature(public_key, message, signature_json)
...
is_valid_altered = verify_signature(public_key, altered_message, signature_json)
